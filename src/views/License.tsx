...
import {Menlo} from '../components';
import {LICENSE_TEXT, LICENSES} from '../licenses';
import {LicenseText} from '../types/license';

type Props = {
  navigation: any;
};

const renderLicenseRow: React.FC<{item: LicenseText}> = ({item}) => {
  return (
...
const License: React.FC<Props> = ({navigation}) => {
  return (
    <>
      <StatusBar
      ...
      <View style={styles.container}>
        ...
        <FlatList
          data={LICENSE_TEXT as LicenseText[]}
